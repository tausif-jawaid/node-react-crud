        ...
        if (!empId.length == 0) {
            if (window.confirm('Do you want to remove?')) {
                const delFetch = empId.map(eleid => {
                    return fetch('http://localhost:8000/employee/' + eleid, {
                        method: 'DELETE'
                    });
                });
                ...
                <div className="card cardsize">
                    ...
                    <div className="card-body">
                        <div className="divbtn">
                            <a onClick={() => { CreateDetails() }} className="btn btn-success">
                        ...
                        <div className="divbtn">
                            <a onClick={() => { removeAll() }} className="btn btn-danger">
                        ...
                        <div className="divbtn">
                            ...
                            >
                                <button className="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-circle-fill" viewBox="0 0 16 16">
                        ...
                        <table ref={tableRef} className="table table-bordered table table-hover fixed_header">
                            <thead className="bg-dark text-white stickheader">
                                <tr>
                                    ...
                                    <td>#</td>
                                    <td onClick={() => sorting('name')}>Name</td>
                                    <td>Email</td>
                                    <td>Phone</td>
                                    <td>Action</td>
                                </tr>
                                ...
                                {empdata &&
                                    empdata.map((item, index) => (
                                        ...
                                        <tr key={item.id}>
                                            ...
                                            <td><a onClick={() => { LoadEdit(item.id) }} className="btn btn-success">
